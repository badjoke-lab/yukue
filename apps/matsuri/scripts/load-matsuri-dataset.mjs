...
export const matsuriF2MaintenanceFiles = Array.from({ length: 73 }, (_, index) => `maintenance-${String(index + 1).padStart(2, "0")}.json`);
export const matsuriF2CorrectionFiles = Array.from({ length: 20 }, (_, index) => `corrections-${String(index + 1).padStart(2, "0")}.json`);
