...
const waveBundle = {
  entities: [...batch14.entities, ...batch15.entities, ...batch16.entities, ...batch17.entities, ...batch18.entities, ...batch19.entities, ...batch20.entities, ...batch21.entities, ...batch22.entities, ...batch23.entities],
  places: [],
  ...
  relations: [],
  designations: [],
  sources: [...batch14.sources, ...batch15.sources, ...batch16.sources, ...batch17.sources, ...batch18.sources, ...batch19.sources, ...batch20.sources, ...batch21.sources, ...batch22.sources, ...batch23.sources, ...maintenance99.sources],
  evidence: [...batch14.evidence, ...batch15.evidence, ...batch16.evidence, ...batch17.evidence, ...batch18.evidence, ...batch19.evidence, ...batch20.evidence, ...batch21.evidence, ...batch22.evidence, ...batch23.evidence, ...maintenance99.evidence],
  images: [...batch14.images, ...batch15.images, ...batch16.images, ...batch17.images, ...batch18.images, ...batch19.images, ...batch20.images, ...batch21.images, ...batch22.images, ...batch23.images],
};
