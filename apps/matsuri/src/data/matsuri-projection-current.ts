...
const waveBundle = {
  ...
  places: [...maintenance99.places],
  stateSnapshots: [...maintenance99.stateSnapshots],
  changeEvents: [...maintenance99.changeEvents],
  occurrences: [...maintenance99.occurrences],
  occurrenceSeries: [...maintenance99.occurrenceSeries],
  recurrencePatterns: [...maintenance99.recurrencePatterns],
  relations: [...maintenance99.relations],
  designations: [...maintenance99.designations],
  ...
  images: [...batch14.images, ...batch15.images, ...batch16.images, ...batch17.images, ...batch18.images, ...batch19.images, ...batch20.images, ...maintenance99.images],
};
...
export const matsuriProjection: PublicProjection = {
  ...
  json: {
    ...
    state_snapshots: [...baseProjection.json.state_snapshots, ...waveProjection.json.state_snapshots],
