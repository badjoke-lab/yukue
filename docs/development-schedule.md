...
**Status:** F2-22 completed / F2-23 crawler review next
...
F2-22 verified exact queries for `脚折雨乞` and `相馬野馬追`, detail navigation for `脚折雨乞`, the zero-result state, and zero browser or console errors.
...
F2-23 must verify crawler-facing behavior without submitting the sitemap or enabling Analytics.

## Work allowed before F2-23 completion

- crawler and robots verification tooling,
- canonical and sitemap discovery checks,
- reviewed factual and date-triggered maintenance,
- Source, Evidence, and Relation corrections,
- security and dependency maintenance,
- repairs required to keep repository and production verification gates green.
