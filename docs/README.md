...
| `audits/matsuri-batch-30-production-verification-2026-08-05.md` | Passed production audit | Batch 30 release, exact counts, Saidaiji Eyo and Soma Nomaoi routes, sitemap, title, and indexability verification |
