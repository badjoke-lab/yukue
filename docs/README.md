...
| `source-evidence-audit.md` | F2 baseline / 2026-07-20 organization maintenance verified | Source metadata, Evidence targeting, freshness boundaries, and reviewed external-link coverage |
