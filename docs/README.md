...
| `audits/matsuri-batch-28-production-verification-2026-08-05.md` | Passed production audit | Batch 28 release, exact counts, Niihama and Aso routes, sitemap, title, and indexability verification |
