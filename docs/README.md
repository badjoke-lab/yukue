...
| `audits/matsuri-batch-40-production-verification-2026-08-10.md` | Passed production audit | Batch 40 release, exact counts, Niigata routes, 2025 held/modified assertion, sitemap, and canonical verification |
