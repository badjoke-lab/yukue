...
| `audits/matsuri-corpus-expansion-batch-12-2026-07-27.md` | Validation running | Okinawa breadth addition and Aomori occurrence/change-history depth maintenance |
...
| `audits/matsuri-corpus-expansion-batch-12-2026-07-27.md` | Validation running | Batch 12 Sources, Evidence, expected counts, product behavior, and boundaries |
