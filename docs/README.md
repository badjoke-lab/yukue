...
| `matsuri-correction-contract.md` | F2-P10 through F2-P12 completed | Ordered full-record correction rules, all-family coverage, exact bundle order, and one shared correction engine |
