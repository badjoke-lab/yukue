...
| `audits/matsuri-batch-27-production-verification-2026-08-03.md` | Passed production audit | Batch 27 release, exact counts, Takamatsu and Hayachine routes, sitemap, title, and indexability verification |
