...
| `audits/matsuri-corpus-expansion-batch-12-2026-07-28.md` | Validation pending | Okinawa breadth addition and Aomori occurrence/change-history depth maintenance |
...
| `audits/matsuri-corpus-expansion-batch-12-2026-07-28.md` | Validation pending | Batch 12 Sources, Evidence, expected counts, product behavior, and boundaries |
