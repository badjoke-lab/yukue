...
| `audits/matsuri-batch-33-production-verification-2026-08-09.md` | Passed production audit | Batch 33 release, exact counts, Chigasaki routes, Sendai dated maintenance, sitemap, and canonical verification |
