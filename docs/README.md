...
| `audits/matsuri-corpus-expansion-batch-11-2026-07-27.md` | Implemented / validation pending | First measured post-Detail-C breadth-and-depth corpus expansion |
...
| `audits/matsuri-corpus-expansion-batch-11-2026-07-27.md` | Active corpus evidence | Coverage audit, selected breadth/depth records, and resulting corpus totals |
