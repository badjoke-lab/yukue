...
| `technical-architecture.md` | F2-22 verified baseline | Build, projection, deployment, dual artifacts, canonical HTTP, and live browser Search |
| `deployment-topology.md` | Matsuri active | Separate portal/site Workers, active Matsuri origin, browser Search evidence, and migration invariants |
...
| `f2-22-browser-search-verification.md` | Completed | Live Chromium query, filter, result-navigation, empty-state, and evidence contract |
| `cloudflare-pages-launch-runbook.md` | F2-16–F2-22 completed | Workers Builds contract, canonical deployment, browser Search verification, and remaining sequence |
...
| `audits/matsuri-f2-22-browser-search-2026-07-13.md` | Passed audit | Exact query, prefecture filter, result navigation, empty state, errors, and screenshots |
...
| `release-verification.md` | F2-22 verified baseline | Unified release, topology, canonical HTTP, browser Search, and external limits |
| `release-candidate.md` | F2-22 evidence recorded | Origin-neutral artifact, hashes, canonical metadata, browser Search metadata, and F2-23 pending state |
| `repository-launch-readiness.md` | Completed repository gate | Required checks, verified canonical and Search state, and remaining external gates |
