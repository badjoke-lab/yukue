...
| `audits/matsuri-batch-36-production-verification-2026-08-09.md` | Passed production audit | Batch 36 release, exact counts, Tottori routes, 2026 scheduled assertion, sitemap, and canonical verification |
