...
| `matsuri-correction-contract.md` | F2-P10 and F2-P11 completed | Ordered full-record correction rules, all-family coverage, and loader/projection bundle-order parity |
