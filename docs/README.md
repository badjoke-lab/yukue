...
| `audits/matsuri-batch-41-production-verification-2026-08-11.md` | Passed production audit | Batch 41 release, exact counts, Yamaguchi routes, 2023 held assertion, sitemap, and canonical verification |
