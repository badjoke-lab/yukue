...
| `visual-review-workflow.md` | Implementation specification | Successful full-page screenshot capture, automated screenshot checks, contact sheets, and human UI review |
